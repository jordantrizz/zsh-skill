...
### Skills Folder
The `skills/` directory contains reusable AI skill packages:
- `skills/zsh-coding-standards/SKILL.md` - canonical Zsh coding standards skill
- `skills/zsh-coding-standards/templates.md` - generation/review/refactor/debug prompt templates
- `skills/zsh-coding-standards/snippets.md` - starter patterns

Use `./sync-skill.sh --local [project_root]` or `./sync-skill.sh --global` to copy the canonical skill files into Copilot skill directories.
